...
- Opens a floating, resizable mirror of that screen, preferably on another display. Scroll or pinch to zoom.
- Opacity and click-through keep the window watchable without blocking the work underneath. Hovering the window still zooms with the scroll wheel; clicks keep going through.
